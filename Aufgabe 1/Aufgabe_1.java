...
class QuellKnoten extends Node {
	...
	public String runNode(String input) throws SoFTException {
		...
		while (diff(Nachbarn(this.myChar()), Empfang) != "" && time() <= 2000) { // solange bis von allen Nachbarknoten empfangen wurde
...
class Knoten extends Node {
	...
	public String runNode(String input) throws SoFTException {
		...
		while (equal(diff(Nachbarn(this.myChar()), Empfang), ersterEmpfang) == false && time() <= 2000) { // solange bis von allen
